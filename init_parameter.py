...
def init_model():
    ...
    parser.add_argument("--dataset_test", default=None, type=str, required=False,
                        help="The name of the dataset to train selected.")
    ...
    parser.add_argument("--save_results_path", type=str, default='outputs_check_v2', help="The path to save results.")
