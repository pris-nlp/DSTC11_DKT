...
class ModelManager_KT:
    
    def __init__(self, args, data, pretrained_model=None):
        set_seed(args.seed)
        if pretrained_model is None:
            pretrained_model = BertForModel_kt.from_pretrained(args.bert_model, num_labels = data.n_known_cls)
        ...
        self.model = BertForModel_kt.from_pretrained(args.bert_model, num_labels = data.n_unknown_cls)
    ...
    def train(self, args, data):
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            eval_acc = self.eval(args, data, 1)
            print(eval_acc)
